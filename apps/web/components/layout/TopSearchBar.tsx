  ...
  return (
    <div className={cn('relative flex-1 max-w-2xl', className)}>
      <div className="relative">
        <Search className="absolute left-[18px] top-1/2 transform -translate-y-1/2 h-5 w-5 text-dark-text-placeholder pointer-events-none" />
        <Input
          type="search"
          placeholder={placeholder}
          className={cn(
            'h-11 pl-[50px] pr-[18px] rounded-[999px]',
            ...
            'text-dark-text-primary placeholder:text-dark-text-placeholder'
          )}
