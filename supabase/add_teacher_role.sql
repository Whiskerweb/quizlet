-- ============================================
-- Migration: Add Teacher Role System
...
-- Step 3: Update existing users to 'student' by default
...
-- Step 5: Update handle_new_user trigger to include role from metadata
...
-- Step 6: Update create_or_update_profile function to handle role
...
-- Step 7: Add RLS policies for role-based access (optional, for future use)
-- These policies ensure that certain features can be restricted by role
...
-- SELECT * FROM public.profiles WHERE role = 'teacher' LIMIT 5;
